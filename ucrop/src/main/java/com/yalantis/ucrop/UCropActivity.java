...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        if (mShowBottomControls) {
            ...
            LayoutInflater.from(this).inflate(R.layout.ucrop_controls_custom, wrapper, true);

            ImageView restoreImageView = findViewById(R.id.image_view_restore);
            ImageView rotateImageView = findViewById(R.id.image_view_rotate);
            restoreImageView.setOnClickListener((v) -> resetRotation());
            rotateImageView.setOnClickListener((v) -> rotateByAngle(90));
